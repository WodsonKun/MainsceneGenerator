...
os.makedirs('picto_input', exist_ok=True)
os.makedirs('picto_output', exist_ok=True)
codename = (sys.argv[1:])[0]
os.mkdir("picto_output/" + codename )
...
urllib.request.urlretrieve(urlpng, "picto_input/pictos-sprite.png")
urllib.request.urlretrieve(urlcss, "picto_input/pictos-sprite.css")

pictosspritepng = Image.open(f'picto_input/pictos-sprite.png')
...
for line in open(f'picto_input/pictos-sprite.css'):
    ...
    if ((line[(b - 1):b]) == "{") == True:
        ...
        cropped_example.save("picto_output/"+ codename + "/" + pictoname + ".png")
        c+=256
        d+=256
